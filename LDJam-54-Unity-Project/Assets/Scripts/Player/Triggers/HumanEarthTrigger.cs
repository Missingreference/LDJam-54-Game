...
public class HumanEarthTrigger : MonoBehaviour
{
    ...
    private List<EarthAbility> m_AbilityPool = new List<EarthAbility>();
    ...
    private void Trigger(Vector2 targetPosition)
    {
        ...
        if(m_AbilityPool.Count == 0)
        {
            ...
            EarthAbility slashAbility = slashObject.AddComponent<EarthAbility>();
        ...
        {
            //Pop from pool
            EarthAbility ability = m_AbilityPool[m_AbilityPool.Count - 1];
    ...
    private void PoolAbility(EarthAbility ability)
    {
