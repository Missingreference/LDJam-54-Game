...
public class HumanSmiteTrigger : MonoBehaviour
{
    ...
    private List<SmiteAbility> m_AbilityPool = new List<SmiteAbility>();
    ...
    private void Trigger(Vector2 targetPosition)
    {
        ...
        {
            //Create new
            GameObject slashObject = new GameObject("Smite Ability");
            ...
            SmiteAbility slashAbility = slashObject.AddComponent<SmiteAbility>();
        ...
        {
            //Pop from pool
            SmiteAbility ability = m_AbilityPool[m_AbilityPool.Count - 1];
    ...
    private void PoolAbility(SmiteAbility ability)
    {
