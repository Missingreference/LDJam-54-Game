...
public class HumanThrowKnifeTrigger : MonoBehaviour
{
    ...
    private List<ThrowKnifeAbility> m_AbilityPool = new List<ThrowKnifeAbility>();
    ...
    private void Trigger(Vector2 targetPosition)
    {
        ...
        if(m_AbilityPool.Count == 0)
        {
            ...
            ThrowKnifeAbility slashAbility = slashObject.AddComponent<ThrowKnifeAbility>();
        ...
        {
            //Pop from pool
            ThrowKnifeAbility ability = m_AbilityPool[m_AbilityPool.Count - 1];
    ...
    private void PoolAbility(ThrowKnifeAbility ability)
    {
